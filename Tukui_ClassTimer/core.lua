...
if ( C and C["media"] and C["media"]["uffont"] ) then
	...
	MASTER_FONT = { C["media"]["pixelfont"], 9, "MONOCHROMEOUTLINE" };

	-- Sets font for stack count
	STACKS_FONT = { C["media"]["pixelfont"], 9, "MONOCHROMEOUTLINE" };
else
	-- Sets font for all texts
...
local CLASS_FILTERS = {
		...
		DRUID = { 
			target = { 
				...
				CreateSpellEntry( 5570, nil, {0, 0.50, 0, 1} ), -- Insect Swarm
				CreateSpellEntry( 8921, nil, {0.67, 0.51, 1, 1} ), -- Moonfire
				CreateSpellEntry( 774, nil, {0.93, 0, 0.93, 1} ), -- Rejuvenation
				CreateSpellEntry( 8936, false, nil, nil, 8936 ), -- Regrowth
				CreateSpellEntry( 91565, nil, {0.28, 0.82, 0.8, 1} ), -- Faerie Fire
			...
			procs = {
				...
				CreateSpellEntry( 48518, nil, {0.06, 0.31, 0.55, 1} ), -- Lunar Eclipse
				--CreateSpellEntry( 48517 ), -- Eclipse Solar
				CreateSpellEntry( 48517, nil, {1, 0.49, 0.04, 1} ), -- Solar Eclipse
		...
		HUNTER = { 
			target = {
				...
				CreateSpellEntry( 3674, nil, {0.49, 0, 1, 1} ), -- Black Arrow
			...
			player = {
				...
				CreateSpellEntry( 3045, nil, {0.72, 0, 0, 1} ), -- Rapid Fire
		...
		WARLOCK = { 
			target = {
				CreateSpellEntry( 48181, false, {0.63, 0.80, 0.35, 1}, nil, nil, 48181 ), -- Haunt
				--CreateSpellEntry( 32389 ), -- Shadow Embrace 
				CreateSpellEntry( 172, nil, {1, 0.25, 0.25, 1} ), -- Corruption
				CreateSpellEntry( 87389, nil, {1, 0.25, 0.25, 1} ), -- Corruption
				CreateSpellEntry( 30108, false, {1, 1, 0, 1}, nil, nil, 30108 ), -- Unstable Affliction
				CreateSpellEntry( 603, nil, {1, 0, 1, 1} ), -- Bane of Doom
				CreateSpellEntry( 980, nil, {1, 0, 1, 1} ), -- Bane of Agony
				CreateSpellEntry( 80240, nil, {0.49, 0, 1, 1} ), -- Bane of Havoc
				CreateSpellEntry( 1490, nil, {0.28, 0.82, 0.8, 1} ), -- Curse of the Elements 
				CreateSpellEntry( 86105, nil, {0.28, 0.82, 0.8, 1} ), -- Jinx:Curse of the Elements
				CreateSpellEntry( 1714, nil, {0.28, 0.82, 0.8, 1} ), -- Curse of Tongues
				CreateSpellEntry( 702, nil, {0.28, 0.82, 0.8, 1} ), -- Curse of Weakness
				CreateSpellEntry( 18223, nil, {0.28, 0.82, 0.8, 1} ), -- Curse of Exhaustion
				CreateSpellEntry( 17962, nil, {1, 0.50, 0.14, 1} ), -- Conflagration
				CreateSpellEntry( 348, false, {1, 0.50, 0.14, 1}, nil, nil, 348 ), -- Immolate
